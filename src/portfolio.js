...
const greeting = {
  ...
  subTitle: emoji(
    "Officially I am a Telecom Engineer 📡 but I prefer to describe myself as a technology 👨‍💻, software development 🚀 and music 🎸 enthusiast."
  ),
  resumeLink: "https://www.dropbox.com/s/pajkxnhehv08qpg/CV.pdf?dl=0",
...
const skillsSection = {
  title: "What can I do?",
  subTitle: emoji(
    "Languages ​​and tools I have worked with (at least once, not kidding)"
  ),
  skills: [
    emoji(
    ...
    emoji("⚡ Basic knowledge of ML, DL, Cibersecurity and Network Protocols."),
  ...
  schools: [
    {
      ...
      duration: "Now",
      desc:
        "Multidisciplinary track studying subjects related to ML, DL, cybersecurity and networks."
      // descBullets: [
    ...
    },
    {
      ...
      duration: "June 2020",
      desc: "Major in Telematics Systems"
    }
  ]
};
  ...
  achievementsCards: [
    {
      ...
      subtitle: "National Instruments (Expired February 2020)",
...
const blogSection = {
  ...
  blogs: [
    {
      url: "https://upcommons.upc.edu/handle/2117/329276",
      title:
        "Data synchronization for a fingerprinting-based mobile location app",
      description:
    ...
    {
      url:
        "https://www.dropbox.com/s/dltblxv1y0slokk/Kaggle%20Competition%20Paper%20by%20Riera-Wasmer%20Fall%202020.pdf?dl=0",
